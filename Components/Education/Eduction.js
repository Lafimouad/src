...
import { educationSection } from "../../techfolio";
import Heading from "../common/Heading";
import { isMobile } from "react-device-detect";

function Education() {
  const experiences = educationSection.experiences.map((experience, i) => {
    return <ExperienceCard experience={experience}  sectionName="education" key={i} />;
  });
  return (
    <Fragment>
      {isMobile && <Heading heading={"Education"} />}
      <section
