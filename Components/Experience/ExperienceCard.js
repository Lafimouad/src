...
function ExperienceCard({ experience ,sectionName='experiences'}) {
  ...
  return (
    <div id="time_line_5cf90ca818f641" className="time_line-item  item_show">
      ...
      {experience.company && experience.company.length > 1? <h5 className="time_line-title"> {experience.company}     <a href={experience.companyLink} target="_blank" rel="noopener noreferrer">  <i class="fas fa-solid fa-link"></i> </a></h5>:<></>}
